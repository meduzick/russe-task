...
def calculate_positions(lexemmes, corpus, analyzer, original_seqs, or_positions):
  '''
  =============================================================
  ...
  for lex, sentence, original_seq, ps in \
               zip(lexemmes, corpus, original_seqs, or_positions):
